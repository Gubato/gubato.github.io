...
-   Year with most minutes played - 2021 (Probably COVID related)
...
-   User doesn't seem to like newer artists
...
-   Only John Mayer is one of the newer artists that the user enjoys.
...
-   User picks The Killers and Howard Shore as top choices.
...
## Ending tracks reasons comparison

```{python}
# Reasons for ending tracks
...
-   User likes to finish the whole track 51% of the times.
...
-   This relates directly to the previous slide.
